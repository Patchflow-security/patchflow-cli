class Patchflow < Formula
  ...
  url "https://github.com/Patchflow-security/patchflow-cli/archive/refs/tags/v0.1.0.tar.gz"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-s -w \
      ...
      -X github.com/Patchflow-security/patchflow-cli/pkg/version.Commit=brew \
      -X github.com/Patchflow-security/patchflow-cli/pkg/version.Date=#{Time.now.utc.iso8601}")
  end
